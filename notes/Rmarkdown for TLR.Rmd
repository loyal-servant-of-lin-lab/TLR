...
estws_prop <- list()
estws_prop$alpha10 <- round((1-estws$alpha1)*estws$alpha2,3)
estws_prop$alpha01 <- round(estws$alpha1*(1-estws$alpha2),3)
estws_prop$alpha00 <- round(estws$alpha1*estws$alpha2,3)

index_TLR <- TLR(p.M,p.Y,estws_prop,coefs,coefs2,significance_upper = sig_level,control.method="FDR",ifcond = 1)
